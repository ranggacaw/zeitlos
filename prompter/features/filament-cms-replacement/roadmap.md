...
|-----------|-------|----------------------|-----------|--------|
| 1 | Install Filament, configure admin-only panel at `/admin`, add Zeitlos-themed dashboard, and add basic Player + Match resources | `add-filament-admin-foundation` | — | scaffolded |
...
**Next up:** `add-filament-admin-foundation` — Increment 1 (Install Filament, configure admin-only panel at `/admin`, add Zeitlos-themed dashboard, and add basic Player + Match resources).
