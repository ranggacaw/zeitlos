...
**Next up:** `replace-inertia-admin-with-filament` — Increment 5 (Retire or redirect the old custom Inertia admin routes/pages/controllers and update specs/tests to make Filament the admin source of truth) after Increment 4 is implemented and archived.
